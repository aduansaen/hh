-- Tạo một đối tượng ScreenGui để chứa thông báo
local screenGui = Instance.new("ScreenGui")
screenGui.Parent = game:GetService("Players").LocalPlayer.PlayerGui

-- Tạo một đối tượng ImageLabel để hiển thị ảnh
local imageLabel = Instance.new("ImageLabel")
imageLabel.Size = UDim2.new(0, 200, 0, 200) -- Kích thước của ảnh (200x200 pixels)
imageLabel.Position = UDim2.new(0.5, -100, 0.5, -100) -- Vị trí của ảnh ở giữa màn hình
imageLabel.AnchorPoint = Vector2.new(0.5, 0.5) -- Điểm neo ở giữa
imageLabel.BackgroundTransparency = 1 -- Ẩn nền của ImageLabel
imageLabel.Image = "rbxassetid://15435099885" -- Đường dẫn ảnh từ Roblox

-- Thêm ImageLabel vào ScreenGui
imageLabel.Parent = screenGui

-- Tạo một đối tượng TextLabel để hiển thị dòng chữ
local textLabel = Instance.new("TextLabel")
textLabel.Size = UDim2.new(0, 200, 0, 30) -- Kích thước của TextLabel (200x30 pixels)
textLabel.Position = UDim2.new(0.5, -100, 0.75, -15) -- Vị trí của TextLabel
textLabel.AnchorPoint = Vector2.new(0.5, 0.5) -- Điểm neo ở giữa
textLabel.BackgroundTransparency = 1 -- Ẩn nền của TextLabel
textLabel.Text = "src by phu khanh" -- Đoạn văn bản
textLabel.TextColor3 = Color3.fromRGB(255, 255, 255) -- Màu trắng cho văn bản
textLabel.Font = Enum.Font.SourceSansBold -- Chọn font cho văn bản
textLabel.TextSize = 24 -- Kích thước font
textLabel.Parent = screenGui -- Thêm TextLabel vào ScreenGui
...
button.TextColor3 = Color3.fromRGB(255, 255, 255) -- Màu trắng cho văn bản

-- Văn bản trên nút (in hoa)
...
NguyenTien:AddLabel("Owner: PHU KHANH ")
NguyenTien:AddLabel("Support Code:ĐAT 09 (My Girl Friend)")
...
setclipboard("https://youtube.com/@catcudai8948")
Notif.New("Copying To Clipboard DoneðŸŽ‰", 3)
end)
